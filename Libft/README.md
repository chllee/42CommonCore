<p align="center">
  <img src="./Assets/Libft_Banner.jpg" alt="Libft_Banner" width="100%" />
</p>
...
| | | |
|--|--|--|
| isalpha | memcpy | strncmp |
| isdigit | memmove | memchr |
| isalnum | strlcpy | memcmp |
| isascii | strlcat | strnstr |
| isprint | toupper | atoi |
| strlen | tolower | calloc |
...
| ft_lstaddfront | ft_lstaddback | ft_lstiter |
...
<br />
<p align="center">
  <img src="./Assets/libft_results.png" alt="libft_results" width="100%" />
</p>
<br />
